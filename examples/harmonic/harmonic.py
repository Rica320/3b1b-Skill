...
A ~90-second scene written from the 3b1b-math-animation skill alone
(narrative_template.md, animation_rules.md, anti_patterns.md, checklists.md,
manim_helpers.py) with no other reference — the control experiment for
whether the skill's documentation is sufficient on its own. See README.md.
    ...
    Audit:   AUDIT=1 manimgl harmonic.py Harmonic     # reports text overlaps
